...
chcp 65001 >nul
echo ========================================
echo    AI News 训练依赖安装脚本
echo    Conda环境: ai_news_train
echo ========================================
echo.
...
echo [1/5] 创建 Conda 环境 ai_news_train (Python 3.12)...
call conda create -n ai_news_train python=3.12 -y

echo.
echo [2/5] 激活 Conda 环境...
call conda activate ai_news_train
...
echo    使用命令激活环境: conda activate ai_news_train
echo ========================================
endlocal
pause
