...
chcp 65001 >nul
echo ========================================
echo    Product Classification 训练依赖安装脚本
echo    Conda环境: product_class_train
echo ========================================
echo.
...
echo [1/5] 创建 Conda 环境 product_class_train (Python 3.12)...
call conda create -n product_class_train python=3.12 -y

echo.
echo [2/5] 激活 Conda 环境...
call conda activate product_class_train
...
echo    使用命令激活环境: conda activate product_class_train
echo ========================================
endlocal
pause
